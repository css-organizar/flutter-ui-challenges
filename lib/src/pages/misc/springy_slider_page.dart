      ...
      child: Scaffold(
        ...
        body: Column(
          children: <Widget>[
            Expanded(
              child: Center(
                child: SpringySlider(markCount: 12, positiveColor: Colors.pink, negativeColor: Colors.white),
              ),
            ),
            Container(
              color: Colors.pink,
              child: Row(
                ...
                children: <Widget>[_buildTextButton("More", false), _buildTextButton("Stats", false)],
              ),
            )
          ],
        ),
